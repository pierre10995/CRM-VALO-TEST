...
export default function ActivitesPage({ activities, contacts, missions, users, currentUser, onAdd, onEdit, onToggle, onDelete }) {
  ...
  return (
    <div>
      ...
      <div className="card" style={{ padding: 0 }}>
        ...
        {activities.map(a => (
          <div key={a.id} style={{ display: "flex", alignItems: "center", gap: 14, padding: "14px 20px", borderBottom: "1px solid #e2e8f0" }}>
