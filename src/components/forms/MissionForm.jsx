  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      <div className="resp-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr 1fr", gap: 12 }}>
        ...
        <Field label="Commission recruteurs ($)"><input className="input" type="number" value={form.recruiterCommission || ""} onChange={e => f("recruiterCommission", e.target.value)} placeholder="2000" /></Field>
